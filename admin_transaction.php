            ...
            <table class="content-table" style="font-size:12px;height: auto;">
                ...
                <tbody>
                    <?php
                        ...
                        // FIND NUMBER RECORD
                        $sql="SELECT COUNT(*) FROM ADMIN_TRANSACTION WHERE WHO='$accnum'";
                        ...
                        $sql="SELECT * FROM ADMIN_TRANSACTION WHERE WHO='$accnum' LIMIT " . $this_page_first_result . ',' .  $results_per_page;
                        $result = mysqli_query($conn, $sql);
                    ...
                    ?>
                     <tr>
                        <td colspan="4" align="center">
                            <?php
                                if($page != '1')
                                    echo '<a href="admin_transaction.php?page=' . $temp - 1 . '">Previous </a> ';
                                for ($page=1;$page<=$number_of_pages;$page++) {
                                    echo '<a href="admin_transaction.php?page=' . $page . '"> ' . $page . ' </a> ';
                                }
                                echo '<a href="admin_transaction.php?page=' . $temp + 1 . '"> Next</a> ';
                            ?>
                        </td>
                    </tr> 
                </tbody>
