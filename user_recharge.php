<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!is_numeric($moneyadd)) {
            echo "
                <script>
                    alert('Money you input invalid! Input again.');
                    header('Location: user_recharge.php')
                </script>
            ";
        }
    	else if ($moneyadd <= 0) {
    		...
    		if ($result) {
                ...
                VALUE 
                (" . "current_timestamp()," . " '$accnum','RECHARGE','+ $$moneyadd')";
                $result = mysqli_query($conn, $code);
    			echo "
	    			<script>
	    				alert('You have recharged successfully with money is $$moneyadd. Current balance is $$moneytotal.');
...
<body>
	<div class="container">
        ...
        <h1 style="color: green; font-size: 30px; text-align: center;">
            RECHARGE<br><br>
        </h1>
