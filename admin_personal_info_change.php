<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE ADMIN SET EMAIL='$email', ADDRESS='$address' WHERE A_ID='$id' ";
        $result = mysqli_query($conn, $sql);
        if ($result) {
...
<head>
    ...
    <script type="text/javascript" src="./js/admin_personal_info_change.js"></script>
    <title>Admin Personal Information Change</title>
</head>
<body>
